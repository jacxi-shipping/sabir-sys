...
class AdvancedSalesDialogNew(QDialog):
    ...
    def init_ui(self):
        ...
        # Date field
        basic_layout.addWidget(QLabel(tr("Date:")), 0, 0)
        ...
        # Party field
        basic_layout.addWidget(QLabel(tr("Customer:")), 1, 0)
        ...
        basic_layout.addWidget(QLabel(tr("Payment Method:")), 2, 0)
        ...
        carton_layout.addWidget(QLabel(tr("Number of Cartons:")), 0, 0)
        ...
        # Grade combo
        carton_layout.addWidget(QLabel(tr("Egg Grade:")), 0, 2)
        ...
        carton_layout.addWidget(QLabel(tr("Total Eggs:")), 1, 0)
        ...
        # Display trays
        carton_layout.addWidget(QLabel(tr("Total Trays:")), 1, 2)
        ...
        # Rate per egg AFG
        pricing_layout.addWidget(QLabel(tr("Rate per Egg (AFG):")), 0, 0)
        ...
        # Rate per egg USD
        pricing_layout.addWidget(QLabel(tr("Rate per Egg (USD):")), 1, 0)
        ...
        notes_label = QLabel(tr("Notes / Comments"))
        ...
        self.notes_edit.setPlaceholderText(tr("Add any additional notes here..."))
